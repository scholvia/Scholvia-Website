...
<section class="page-hero">
  <div class="container">
    <h1><?php scholvia_te('contact_hero_title_prefix'); ?> <span class="text-gradient"><?php scholvia_te('contact_hero_title_gradient'); ?></span></h1>
    <p><?php scholvia_te('contact_hero_subtitle'); ?></p>
  </div>
</section>
  ...
  <div class="container">
    <div class="contact-layout">
      ...
      <div class="glass-card contact-form-wrapper reveal">
        <h2><?php scholvia_te('contact_form_title'); ?></h2>
        <p><?php scholvia_te('contact_form_subtitle'); ?></p>
        <form id="contactForm">
          <?php wp_nonce_field('scholvia_contact', 'scholvia_contact_nonce'); ?>
          <div class="form-group">
            <label for="name"><?php scholvia_te('form_label_name'); ?></label>
            <input type="text" id="name" name="name" placeholder="<?php echo esc_attr(scholvia_t('form_placeholder_name')); ?>" required>
          </div>
          <div class="form-group">
            <label for="email"><?php scholvia_te('form_label_email'); ?></label>
            <input type="email" id="email" name="email" placeholder="<?php echo esc_attr(scholvia_t('form_placeholder_email')); ?>" required>
          </div>
          <div class="form-group">
            <label for="phone"><?php scholvia_te('form_label_phone'); ?></label>
            <input type="tel" id="phone" name="phone" placeholder="<?php echo esc_attr(scholvia_t('form_placeholder_phone')); ?>">
          </div>
          <div class="form-group">
            <label for="service"><?php scholvia_te('form_label_service'); ?></label>
            <select id="service" name="service" required>
              <option value="" disabled selected><?php scholvia_te('form_select_default'); ?></option>
              <option value="University Enrollment"><?php scholvia_te('form_option_enrollment'); ?></option>
              <option value="Language Courses"><?php scholvia_te('form_option_language'); ?></option>
              <option value="Visa Consultation"><?php scholvia_te('form_option_visa'); ?></option>
              <option value="Education-Tourism"><?php scholvia_te('form_option_tourism'); ?></option>
              <option value="24/7 Support"><?php scholvia_te('form_option_support'); ?></option>
              <option value="General Inquiry"><?php scholvia_te('form_option_general'); ?></option>
            </select>
          </div>
          <div class="form-group">
            <label for="message"><?php scholvia_te('form_label_message'); ?></label>
            <textarea id="message" name="message" placeholder="<?php echo esc_attr(scholvia_t('form_placeholder_message')); ?>" required></textarea>
          </div>
          <button type="submit" class="btn btn-primary form-submit"><?php scholvia_te('form_btn_send'); ?></button>
      ...
      <div class="contact-info-side">
        ...
        <div class="glass-card contact-info-card card-email reveal">
          ...
          <div class="contact-info-text">
            <h3><?php scholvia_te('contact_email_label'); ?></h3>
        ...
        <div class="glass-card contact-info-card card-phone reveal" style="transition-delay: 0.05s;">
          ...
          <div class="contact-info-text">
            <h3><?php scholvia_te('contact_phone_label'); ?></h3>
            <div class="phone-numbers">
              <div class="phone-country">
                <span class="phone-flag">&#127470;&#127465;</span>
                <div class="phone-detail">
                  <small><?php scholvia_te('contact_indonesia'); ?></small>
              ...
              <div class="phone-country">
                <span class="phone-flag">&#127474;&#127486;</span>
                <div class="phone-detail">
                  <small><?php scholvia_te('contact_malaysia'); ?></small>
        ...
        <div class="glass-card contact-info-card reveal" style="transition-delay: 0.1s;">
          ...
          <div class="contact-info-text">
            <h3><?php scholvia_te('contact_jakarta_office'); ?></h3>
            <p><?php scholvia_te('contact_jakarta_address'); ?></p>
            <span class="office-tag">&#127470;&#127465; <?php scholvia_te('contact_headquarters'); ?></span>
          </div>
        </div>
        ...
        <div class="glass-card contact-info-card reveal" style="transition-delay: 0.15s;">
          ...
          <div class="contact-info-text">
            <h3><?php scholvia_te('contact_kl_office'); ?></h3>
            <p><?php scholvia_te('contact_kl_address'); ?></p>
            <span class="office-tag">&#127474;&#127486; <?php scholvia_te('contact_branch_office'); ?></span>
          </div>
        </div>
...
<section class="social-section">
  <div class="container text-center">
    <div class="reveal">
      <span class="section-label"><?php scholvia_te('social_label'); ?></span>
      <h2 class="section-title"><?php scholvia_te('social_title'); ?></h2>
      <p class="section-subtitle"><?php scholvia_te('social_subtitle'); ?></p>
    </div>
    <div class="social-pills reveal">
      <a href="https://instagram.com/scholviaofficial" target="_blank" rel="noopener" class="social-pill ig">
        ...
        <?php scholvia_te('social_instagram'); ?>
      </a>
      <a href="https://facebook.com/share/1Yma7Hx8Kg/" target="_blank" rel="noopener" class="social-pill fb">
        ...
        <?php scholvia_te('social_facebook'); ?>
      </a>
      ...
      <a href="https://linkedin.com/company/scholvia/" target="_blank" rel="noopener" class="social-pill li">
        ...
        <?php scholvia_te('social_linkedin'); ?>
      </a>
...
<section class="cta-section">
  <div class="container reveal">
    ...
    <div class="cta-buttons">
      <a href="https://wa.me/6281388666994" target="_blank" rel="noopener" class="btn btn-primary"><?php scholvia_te('cta_btn_whatsapp'); ?></a>
      <a href="mailto:study@scholvia.com" class="btn btn-outline"><?php scholvia_te('cta_btn_email'); ?></a>
    </div>
  </div>
</section>

<script>
var scholviaFormI18n = {
  sending: <?php echo wp_json_encode(scholvia_t('form_sending')); ?>,
  sendMessage: <?php echo wp_json_encode(scholvia_t('form_btn_send')); ?>,
  success: <?php echo wp_json_encode(scholvia_t('form_success')); ?>,
  error: <?php echo wp_json_encode(scholvia_t('form_error')); ?>,
  networkError: <?php echo wp_json_encode(scholvia_t('form_network_error')); ?>,
  waIntro: <?php echo wp_json_encode(scholvia_t('form_wa_intro')); ?>
};
document.getElementById('contactForm')?.addEventListener('submit', function(e) {
  ...
  btn.disabled = true;
  btn.textContent = scholviaFormI18n.sending;
  msg.className = '';
  ...
  .then(function(res) {
    if (res.success) {
      ...
      msg.textContent = res.data || scholviaFormI18n.success;
      form.reset();

      // Build WhatsApp URL with form data
      var waText = scholviaFormI18n.waIntro + '\n\n';
      waText += 'Name: ' + nameVal + '\n';
      ...
      msg.style.display = 'block';
      msg.textContent = res.data || scholviaFormI18n.error;
    }
    btn.disabled = false;
    btn.textContent = scholviaFormI18n.sendMessage;
  })
  .catch(function() {
    msg.className = 'form-message--error';
    msg.style.display = 'block';
    msg.textContent = scholviaFormI18n.networkError;
    btn.disabled = false;
    btn.textContent = scholviaFormI18n.sendMessage;
  });
});
