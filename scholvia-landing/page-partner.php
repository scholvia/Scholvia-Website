...
<section class="why-partner-section">
  <div class="container text-center">
    <div class="reveal">
      ...
      <p class="section-subtitle">We deliver quality applications and better conversion outcomes for your institution.</p>
    </div>
    <div class="why-partner-grid">
      <div class="glass-card-dark reveal">
        ...
        <h3>Market Access</h3>
        <p>Strong access to the Indonesian student market with established networks across major cities.</p>
      </div>
      <div class="glass-card-dark reveal" style="transition-delay: 0.1s;">
        ...
        <p>Personalized recruitment approach with thorough pre-screening — not just referrals, but qualified applicants.</p>
      </div>
      <div class="glass-card-dark reveal" style="transition-delay: 0.2s;">
        ...
        <p>We manage the entire student journey from first contact to enrollment, with professional and responsive communication.</p>
      </div>
    </div>
  </div>
</section>
